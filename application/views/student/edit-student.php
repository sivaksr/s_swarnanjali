			...
			<input type="hidden" name="student_id" id="student_id" value="<?php echo isset($student_list['u_id'])?$student_list['u_id']:''; ?>">
					...
					<!--school details-->
						...
						<div class="row">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="roll_number" placeholder="Enter Admission Number" value="<?php echo isset($student_list['roll_number'])?$student_list['roll_number']:''; ?>" />
                            </div>
                        </div>
						</div>
						...
						<div class="form-group">
							...
							<div class="row">
								<div class=" col-md-12">
									...
									<label class=" control-label">Mobile</label>
										<div class="">
											<input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo isset($student_list['mobile'])?$student_list['mobile']:''; ?>" placeholder="Enter Mobile" />
										</div>
									</div>
								</div>
							...
							<div class=" col-md-6">
									<div class="form-group">
									 <label class=" control-label">Bus Transport</label>
										<div class="">
											<select class="form-control" name="bus_transport" id="bus_transport">
												<option value="">Select</option>
												<option value="Yes" <?php if($student_list['bus_transport']=='Yes'){ echo "selected"; } ?>>Yes</option>
												<option value="No" <?php if($student_list['bus_transport']=='No'){ echo "selected"; } ?>>No</option>
											</select>
										</div>
									</div>
								</div>
...
//       
        fields: {
           ...
           confirmpassword: {
			...
			validators: {
					notEmpty: {
						message: 'Bus Transport is required'
					}
				}
            },
			profile_pic: {
